...
@section('title', 'Top Express | Firme')
@section('custom-css')
        ...
        <div class="card-body">
            <form action="">
                ...
                <div class="mt-3">
                    ...
                    <a href="{{ route('cms.kompanija.index') }}" class="btn btn-sm btn-primary">Resetuj</a>
                </div>
            </form>
        </div>
    </div>
</div>
<x-kompanija-tabela :kompanije="$kompanije"></x-kompanija-tabela>
@endsection
