...
@section('title', 'Top Express | Gradovi')
@section('custom-css')
    ...
    <div class="card">
        <div class="card-body">
            <form action="">
                ...
                <div class="mt-3">
                    <a href="{{ route('cms.te_grad.create') }}" class="btn btn-sm btn-primary">Dodaj grad +</a>
                    <button class="btn btn-sm btn-primary" type="submit">Pretraži</button>
                    <a href="{{ route('cms.te_grad.index') }}" class="btn btn-sm btn-primary">Resetuj</a>
                </div>
            </form>
        </div>
    </div>
...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Lista gradova</h4>
          ...
          <table class="table table-bordered table-sm">
            ...
            <tbody>
                @foreach ($gradovi as $grad)
                    <tr>
                      <td><a href="{{ route('cms.te_grad.edit', $grad) }}" class="btn btn-sm btn-primary">Izmeni  <i class="mdi mdi-lead-pencil"></i></a></td>
                      <td>{!! $grad->naziv !!}</td>
                      <td>{!! $grad->id !!}</td>
                    </tr>
                @endforeach
