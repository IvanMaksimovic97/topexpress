...
@section('title', 'Top Express | Korisnici')
@section('custom-css')
        ...
        <div class="card-body">
            <form action="">
                ...
                <div class="mt-3">
                    ...
                    <a href="{{ route('cms.korisnik.index') }}" class="btn btn-sm btn-primary">Resetuj</a>
                </div>
            </form>
        </div>
    </div>
</div>
<x-korisnik-tabela :korisnici="$korisnici"></x-korisnik-tabela>
@endsection