    ...
    public static function stampajAdresniceA4($posiljke, $template)
    {
        ...
        foreach ($posiljke as $chunk) {
            ...
            $replacements[] = [
                ...
                'Kompanija1' => isset($chunk[0]) ? substr(str_replace('&', '', $chunk[0]['firma'] ? $chunk[0]['firma']['naziv_pun'] : $chunk[0]['posiljalac']['naziv']), 0, 20) : '',
                'AdresaKompanije1' => isset($chunk[0]) ? substr(str_replace('&', '', $chunk[0]['firma'] ? $chunk[0]['firma']['adresa'] : $chunk[0]['posiljalac']['naselje']['naziv'].', '.$chunk[0]['posiljalac']['ulica']['naziv'].' '.$chunk[0]['posiljalac']['broj']), 0, 20) : '',
                'TelefonKompanije1' => isset($chunk[0]) ? substr(str_replace('&', '', $chunk[0]['firma'] ? $chunk[0]['firma']['telefon'] : $chunk[0]['posiljalac']['kontakt_telefon']), 0, 20) : '',
                'ImePrezime1' => isset($chunk[0]) ? substr(str_replace('&', '', $chunk[0]['primalac']['naziv']), 0, 20) : '',
                'Adresa1' => isset($chunk[0]) ? substr(str_replace('&', '', $chunk[0]['primalac']['ulica']['naziv'].' '.$chunk[0]['primalac']['broj']), 0, 20) : '',
                'Naselje1' => isset($chunk[0]) ? substr(str_replace('&', '', $chunk[0]['primalac']['naselje']['naziv']), 0, 20)  : '',
                'Telefon1' => isset($chunk[0]) ? substr(str_replace('&', '', $chunk[0]['primalac']['kontakt_telefon']), 0, 20) : '',
                'Masa1' => isset($chunk[0]) ? 'MASA: '.$chunk[0]['masa_kg'].' KG' : '',
                'Sadrzaj1' => isset($chunk[0]) ? substr('SADRŽAJ: '.str_replace('&', '', $chunk[0]['sadrzina']), 0, 20) : '',
                ...
                'Kompanija2' => isset($chunk[1]) ? substr(str_replace('&', '', $chunk[1]['firma'] ? $chunk[1]['firma']['naziv_pun'] : $chunk[1]['posiljalac']['naziv']), 0, 20) : '',
                'AdresaKompanije2' => isset($chunk[1]) ? substr(str_replace('&', '', $chunk[1]['firma'] ? $chunk[1]['firma']['adresa'] : $chunk[1]['posiljalac']['naselje']['naziv'].', '.$chunk[1]['posiljalac']['ulica']['naziv'].' '.$chunk[1]['posiljalac']['broj']), 0, 20) : '',
                'TelefonKompanije2' => isset($chunk[1]) ? substr(str_replace('&', '', $chunk[1]['firma'] ? $chunk[1]['firma']['telefon'] : $chunk[1]['posiljalac']['kontakt_telefon']), 0, 20) : '',
                'ImePrezime2' => isset($chunk[1]) ? substr(str_replace('&', '', $chunk[1]['primalac']['naziv']), 0, 20) : '',
                'Adresa2' => isset($chunk[1]) ? substr(str_replace('&', '', $chunk[1]['primalac']['ulica']['naziv'].' '.$chunk[1]['primalac']['broj']), 0, 20) : '',
                'Naselje2' => isset($chunk[1]) ? substr(str_replace('&', '', $chunk[1]['primalac']['naselje']['naziv']), 0, 20)  : '',
                'Telefon2' => isset($chunk[1]) ? substr(str_replace('&', '', $chunk[1]['primalac']['kontakt_telefon']), 0, 20) : '',
                'Masa2' => isset($chunk[1]) ? 'MASA: '.$chunk[1]['masa_kg'].' KG' : '',
                'Sadrzaj2' => isset($chunk[1]) ? substr('SADRŽAJ: '.str_replace('&', '', $chunk[1]['sadrzina']), 0, 20) : '',
                ...
                'Kompanija3' => isset($chunk[2]) ? substr(str_replace('&', '', $chunk[2]['firma'] ? $chunk[2]['firma']['naziv_pun'] : $chunk[2]['posiljalac']['naziv']), 0, 20) : '',
                'AdresaKompanije3' => isset($chunk[2]) ? substr(str_replace('&', '', $chunk[2]['firma'] ? $chunk[2]['firma']['adresa'] : $chunk[2]['posiljalac']['naselje']['naziv'].', '.$chunk[2]['posiljalac']['ulica']['naziv'].' '.$chunk[2]['posiljalac']['broj']), 0, 20) : '',
                'TelefonKompanije3' => isset($chunk[2]) ? substr(str_replace('&', '', $chunk[2]['firma'] ? $chunk[2]['firma']['telefon'] : $chunk[2]['posiljalac']['kontakt_telefon']), 0, 20) : '',
                'ImePrezime3' => isset($chunk[2]) ? substr(str_replace('&', '', $chunk[2]['primalac']['naziv']), 0, 20) : '',
                'Adresa3' => isset($chunk[2]) ? substr(str_replace('&', '', $chunk[2]['primalac']['ulica']['naziv'].' '.$chunk[2]['primalac']['broj']), 0, 20) : '',
                'Naselje3' => isset($chunk[2]) ? substr(str_replace('&', '', $chunk[2]['primalac']['naselje']['naziv']), 0, 20)  : '',
                'Telefon3' => isset($chunk[2]) ? substr(str_replace('&', '', $chunk[2]['primalac']['kontakt_telefon']), 0, 20) : '',
                'Masa3' => isset($chunk[2]) ? 'MASA: '.$chunk[2]['masa_kg'].' KG' : '',
                'Sadrzaj3' => isset($chunk[2]) ? substr('SADRŽAJ: '.str_replace('&', '', $chunk[2]['sadrzina']), 0, 20) : '',
                ...
                'Kompanija4' => isset($chunk[3]) ? substr(str_replace('&', '', $chunk[3]['firma'] ? $chunk[3]['firma']['naziv_pun'] : $chunk[3]['posiljalac']['naziv']), 0, 20) : '',
                'AdresaKompanije4' => isset($chunk[3]) ? substr(str_replace('&', '', $chunk[3]['firma'] ? $chunk[3]['firma']['adresa'] : $chunk[3]['posiljalac']['naselje']['naziv'].', '.$chunk[3]['posiljalac']['ulica']['naziv'].' '.$chunk[3]['posiljalac']['broj']), 0, 20) : '',
                'TelefonKompanije4' => isset($chunk[3]) ? substr(str_replace('&', '', $chunk[3]['firma'] ? $chunk[3]['firma']['telefon'] : $chunk[3]['posiljalac']['kontakt_telefon']), 0, 20) : '',
                'ImePrezime4' => isset($chunk[3]) ? substr(str_replace('&', '', $chunk[3]['primalac']['naziv']), 0, 20) : '',
                'Adresa4' => isset($chunk[3]) ? substr(str_replace('&', '', $chunk[3]['primalac']['ulica']['naziv'].' '.$chunk[3]['primalac']['broj']), 0, 20) : '',
                'Naselje4' => isset($chunk[3]) ? substr(str_replace('&', '', $chunk[3]['primalac']['naselje']['naziv']), 0, 20)  : '',
                'Telefon4' => isset($chunk[3]) ? substr(str_replace('&', '', $chunk[3]['primalac']['kontakt_telefon']), 0, 20) : '',
                'Masa4' => isset($chunk[3]) ? 'MASA: '.$chunk[3]['masa_kg'].' KG' : '',
                'Sadrzaj4' => isset($chunk[3]) ? substr('SADRŽAJ: '.str_replace('&', '', $chunk[3]['sadrzina']), 0, 20) : '',
